...
CCPotentiometer potentiometer1 {
  ...
  {MIDI_CC::Channel_Volume, CHANNEL_11}, // Channel volume of channel 11
 };
CCPotentiometer potentiometer2 {
   A5,                                   // Analog pin connected to potentiometer
  {MIDI_CC::Channel_Volume, CHANNEL_12}, // Channel volume of channel 12
 };
...
NoteButtonMatrix<8, 8> buttonmatrix = {
  {3, 5, 7, 9, 11, 13, A1, A3}, // row pins
  {2, 4, 6, 8, 10, 12, A0, A2},  // column pins

  
  addresses, // address matrix
  CHANNEL_8, // channel and cable number
};
void setup() {
